    ...
    >
      ...
      <div className="relative aspect-[4/3] overflow-hidden bg-[#EFEFEB]">
        ...
        <button
          ...
          className={cn(
            "absolute top-2 right-2 w-8 h-8 rounded-full flex items-center justify-center z-10 transition-all duration-200",
            saved
              ? "bg-[#E8621A] hover:bg-[#C9521A]"
